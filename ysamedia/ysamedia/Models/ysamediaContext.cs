...
{
    public partial class ysamediaContext : DbContext
    {
        public ysamediaContext()
        {
        }

        public ysamediaContext(DbContextOptions<ysamediaContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblAnswer>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tblAnswer_tblUser");
            });
            ...
            modelBuilder.Entity<TblDependant>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tblDependant_tblUser");
            });
            ...
            modelBuilder.Entity<TblOccupation>(entity =>
            {
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_tblOccupation_tblUser");
            });
            ...
            modelBuilder.Entity<TblUser>(entity =>
            {
                ...
                entity.Property(e => e.DateJoinedChurch).HasColumnType("date");
                ...
                entity.HasOne(d => d.AgeGroup)
                    ...
                    .HasConstraintName("FK_tblUser_tblAgeGroup");
                ...
                entity.HasOne(d => d.Relationship)
                    ...
                    .HasConstraintName("FK_tblUser_tblRelationshipStatus");
            });
